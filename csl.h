...
#include <windows.h>
using namespace std;
inline void DisableResizeWindow();//Vo hieu hoa thay doi kich thuoc
inline void DisableCtrButton(bool Close, bool Min, bool Max);//Vo hieu hoa nut minsize,maxsize
inline void ShowScrollbar(BOOL Show);
inline void Nocursortype(bool visible, DWORD size);//Xoa Con tro
...
inline void DisableCtrButton(bool Close, bool Min, bool Max)
{
    HWND hWnd = GetConsoleWindow();
...
inline void Nocursortype(bool visible, DWORD size)
{
